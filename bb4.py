...
data.to_csv("opt4_Wolfe_27.csv", index=None)
data = pd.DataFrame(res8[4]).reset_index(drop=True)
data.columns = ['MCGD_Wolfe']
data.to_csv("opt4(value)_Wolfe_27.csv", index=None)

res8 = opt4(50, 5, 1)
data = pd.DataFrame(res8).reset_index(drop=True)
data.to_csv("opt4_Wolfe_28.csv", index=None)
data = pd.DataFrame(res8[4]).reset_index(drop=True)
data.columns = ['MCGD_Wolfe']
data.to_csv("opt4(value)_Wolfe_28.csv", index=None)

res8 = opt4(50, 5, 1)
data = pd.DataFrame(res8).reset_index(drop=True)
data.to_csv("opt4_Wolfe_29.csv", index=None)
data = pd.DataFrame(res8[4]).reset_index(drop=True)
data.columns = ['MCGD_Wolfe']
data.to_csv("opt4(value)_Wolfe_29.csv", index=None)


res8 = opt4(50, 5, 1)
data = pd.DataFrame(res8).reset_index(drop=True)
data.to_csv("opt4_Wolfe_30.csv", index=None)
data = pd.DataFrame(res8[4]).reset_index(drop=True)
data.columns = ['MCGD_Wolfe']
data.to_csv("opt4(value)_Wolfe_30.csv", index=None)